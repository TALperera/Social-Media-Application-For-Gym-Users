...
export default function Middle() {
  ...
  const onFileUpload = () => {
    ...
    axios
      .post("http://localhost:8089/api/media/upload/image", formData)
      .then((response) => {
  ...
  const fetchAllImage = async () => {
    axios
      .get("http://localhost:8089/api/media/all")
      .then((response) => {
  ...
  const handleDelete = (planId) => {
    axios
      .delete("http://localhost:8089/api/media/delete/media/" + planId)
      .then((response) => {
  ...
  const updateMedia = () => {
    ...
    axios
      .put(
        `http://localhost:8089/api/media/update/image/${currentPost.id}`,
        formData
      )
      .then((response) => {
            ...
            <div className="feed" key={post.id}>
              <div className="head">
                <div className="user">
                  ...
                  <div className="info">
                    {/* <h3>{username}</h3> */}
                    <small>Colombo, 15 Minutes Ago</small>
                  </div>
                </div>
                <span
                  className="edit"
